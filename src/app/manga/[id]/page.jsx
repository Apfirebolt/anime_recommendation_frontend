    ...
    return (
      <div className="min-h-screen bg-anime-dark text-anime-light flex flex-col font-sans">
        ...
        <div className="flex-grow flex flex-col items-center justify-center space-y-4 px-6 text-center">
          <BookOpenIcon className="h-16 w-16 text-anime-light/30" />
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="space-y-2">
              ...
              {manga.title_japanese && (
                <p className="text-sm font-heading text-anime-light/50">{manga.title_japanese}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-xl bg-anime-dark/40 border border-anime-sage/10">
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold font-heading text-anime-light">{manga.score || 'N/A'}</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold font-heading text-anime-light">{manga.chapters || 'Ongoing'}</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold font-heading text-anime-light">{manga.volumes || 'Ongoing'}</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold font-heading text-anime-light truncate" title={manga.authors || 'Unknown'}>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold font-heading text-anime-light truncate" title={manga.serializations || 'N/A'}>
        ...
        <div className="space-y-6 pt-8 border-t border-anime-sage/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-anime-light/60">Top 10 similar manga to <span className="font-semibold text-anime-coral/80">{manga.title}</span></p>
            </div>
          </div>
